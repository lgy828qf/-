...
(function () {
  ...
  if (topWindow == window) {
    ...
    actionPvpBtn.onclick = async function () {
      ...
      if (getSelectedOptionsPVP() == "dianfengjingji") {
        await dianfeng("jingji")
      }
      if (getSelectedOptionsPVP() == "dianfengkuangye") {
    ...
    radio2.value = 'dianfengjingji';
    // 创建标签2
    var label2 = document.createElement('label');
    label2.innerHTML = '巅峰竞技';
    label2.style.fontSize = "10px";
    // 创建单选按钮4
    var radio4 = document.createElement('input');
    radio4.type = 'radio';
    radio4.name = 'optionPVP';
    radio4.value = 'dianfengkuangye';
      // 创建标签2
    var label4 = document.createElement('label');
    label4.innerHTML = '巅峰狂野';
    ...
    catchC.id = 'catchC';
    catchC.placeholder = "捕捉次数";
    catchC.style.width = "100px";
    div.appendChild(catchC);

    var catchR = document.createElement("input");
    catchR.style.marginLeft = "10px";
    catchR.id = 'catchR';
    catchR.value = '1';
    catchR.placeholder = "捕捉回合";
    catchR.style.width = "100px";
    div.appendChild(catchR);

    var 雇佣Uid = document.createElement("input");
    雇佣Uid.style.marginLeft = "10px"
    雇佣Uid.id = '雇佣Uid';
    雇佣Uid.placeholder = "雇佣uid"
  ...
  function getCatchRound() {
    var catchR = document.getElementById('catchR');
    return catchR.value;
  }
